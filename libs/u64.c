    ...
    TypeMap_PushContained(&s->types,funcs,
        Type_Make(U64_TYPE,sizeof(SuperALXVariable),OperatorInterationMap_Make((OperatorInterater[]){
            OperatorInterater_Make((CStr[]){ NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_SUPERALX_NEG,(Token(*)(void*,Token*,Vector*))U64_Handler_Neg),
                OperatorDefiner_New(TOKEN_SUPERALX_INC,(Token(*)(void*,Token*,Vector*))U64_Handler_Inc),
                OperatorDefiner_New(TOKEN_SUPERALX_DEC,(Token(*)(void*,Token*,Vector*))U64_Handler_Dec),
                OperatorDefiner_New(TOKEN_SUPERALX_NOT,(Token(*)(void*,Token*,Vector*))U64_Handler_Not),
                OperatorDefiner_New(TOKEN_SUPERALX_ADR,(Token(*)(void*,Token*,Vector*))U64_Handler_Adr),
                ...
                OperatorDefiner_New(TOKEN_SUPERALX_SIZE,(Token(*)(void*,Token*,Vector*))U64_Handler_Size),
