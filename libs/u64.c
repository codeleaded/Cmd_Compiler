...
Token U64_U64_Handler_Asd(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_ExecuteAss(ll,a,b,op,"add","ASD");
}
Token U64_U64_Handler_Asu(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_ExecuteAss(ll,a,b,op,"sub","ASU");
}
Token U64_U64_Handler_Asm(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
...
Token U64_U64_Handler_Add(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_Execute(ll,a,b,op,"add","ADD",SuperALX_Function_Add);
}
Token U64_U64_Handler_Sub(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_Execute(ll,a,b,op,"sub","SUB",SuperALX_Function_Sub);
}
Token U64_U64_Handler_Mul(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
...
Token U64_Handler_Adr(SuperALX* ll,Token* op,Vector* args){
    ...
    if(a->tt==TOKEN_NUMBER){
        ...
        if(SuperALX_DrefType(ll,v->typename)){
            ...
            SuperALX_Variable_Build_Decl(ll,stack_name,U64_TYPE"*");
        }
...
Token U64_Null_Handler_Cast(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
...
Token U64_Handler_Cast(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
...
void Ex_Packer(ExternFunctionMap* Extern_Functions,Vector* funcs,Scope* s){//Vector<CStr>
    TypeMap_PushContained(&s->types,funcs,
        Type_Make(U64_TYPE,sizeof(SuperALXVariable),OperatorInterationMap_Make((OperatorInterater[]){
            OperatorInterater_Make((CStr[]){ NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_SUPERALX_NEG,(void*)U64_Handler_Neg),
                OperatorDefiner_New(TOKEN_SUPERALX_INC,(void*)U64_Handler_Inc),
                OperatorDefiner_New(TOKEN_SUPERALX_DEC,(void*)U64_Handler_Dec),
                OperatorDefiner_New(TOKEN_SUPERALX_NOT,(void*)U64_Handler_Not),
                OperatorDefiner_New(TOKEN_SUPERALX_ADR,(void*)U64_Handler_Adr),
                OperatorDefiner_New(TOKEN_CAST,(void*)U64_Handler_Cast),
                OperatorDefiner_New(TOKEN_INIT,(void*)SuperALX_Init),
                OperatorDefiner_New(TOKEN_SUPERALX_SIZE,(void*)U64_Handler_Size),
                //OperatorDefiner_New(TOKEN_DESTROY,NULL),
                OPERATORDEFINER_END
            })),
            OperatorInterater_Make((CStr[]){ U8_TYPE,NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_SUPERALX_ASS,(void*)U64_U64_Handler_Ass),
                OperatorDefiner_New(TOKEN_SUPERALX_ASD,(void*)U64_U64_Handler_Asd),
                OperatorDefiner_New(TOKEN_SUPERALX_ASU,(void*)U64_U64_Handler_Asu),
                OperatorDefiner_New(TOKEN_SUPERALX_ASM,(void*)U64_U64_Handler_Asm),
                OperatorDefiner_New(TOKEN_SUPERALX_ASV,(void*)U64_U64_Handler_Asv),
                OperatorDefiner_New(TOKEN_SUPERALX_ADD,(void*)U64_U64_Handler_Add),
                OperatorDefiner_New(TOKEN_SUPERALX_SUB,(void*)U64_U64_Handler_Sub),
                OperatorDefiner_New(TOKEN_SUPERALX_MUL,(void*)U64_U64_Handler_Mul),
                OperatorDefiner_New(TOKEN_SUPERALX_DIV,(void*)U64_U64_Handler_Div),
                OperatorDefiner_New(TOKEN_SUPERALX_MOD,(void*)U64_U64_Handler_Mod),
                OperatorDefiner_New(TOKEN_SUPERALX_AND,(void*)U64_U64_Handler_And),
                OperatorDefiner_New(TOKEN_SUPERALX_OR,(void*)U64_U64_Handler_Or),
                OperatorDefiner_New(TOKEN_SUPERALX_XOR,(void*)U64_U64_Handler_Xor),
                OperatorDefiner_New(TOKEN_SUPERALX_EQU,(void*)U64_U64_Handler_Equ),
                OperatorDefiner_New(TOKEN_SUPERALX_NEQ,(void*)U64_U64_Handler_Neq),
                OperatorDefiner_New(TOKEN_SUPERALX_LES,(void*)U64_U64_Handler_Les),
                OperatorDefiner_New(TOKEN_SUPERALX_GRT,(void*)U64_U64_Handler_Grt),
                OperatorDefiner_New(TOKEN_SUPERALX_LEQ,(void*)U64_U64_Handler_Leq),
                OperatorDefiner_New(TOKEN_SUPERALX_GRQ,(void*)U64_U64_Handler_Grq),
                OPERATORDEFINER_END
            })),
