...
Token U16_U16_Handler_Ass(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_ExecuteAss(ll,a,b,op,"mov","ASS");
}

Token U16_U16_Handler_Asd(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_ExecuteAss(ll,a,b,op,"add","ASD");
}
Token U16_U16_Handler_Asu(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_ExecuteAss(ll,a,b,op,"sub","ASU");
}
Token U16_U16_Handler_Asm(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
...
Token U16_U16_Handler_Add(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_Execute(ll,a,b,op,"add","ADD",SuperALX_Function_Add);
}
Token U16_U16_Handler_Sub(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_Execute(ll,a,b,op,"sub","SUB",SuperALX_Function_Sub);
}
Token U16_U16_Handler_Mul(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
...
Token U16_Handler_Neg(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    return SuperALX_ExecuteSingle(ll,a,op,"neg","NEG",SuperALX_Function_Neg);
}
Token U16_Handler_Inc(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    return SuperALX_ExecuteAssSingle(ll,a,op,"inc","INC");
}
Token U16_Handler_Dec(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    return SuperALX_ExecuteAssSingle(ll,a,op,"dec","DEC");
}

Token U16_U16_Handler_And(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_Execute(ll,a,b,op,"and","AND",SuperALX_Function_And);
}
Token U16_U16_Handler_Or(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_Execute(ll,a,b,op,"or","OR",SuperALX_Function_Or);
}
Token U16_U16_Handler_Xor(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    Token* b = (Token*)Vector_Get(args,1);
    return SuperALX_Execute(ll,a,b,op,"xor","XOR",SuperALX_Function_Xor);
}
Token U16_Handler_Not(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
...
Token U16_Handler_Adr(SuperALX* ll,Token* op,Vector* args){
    ...
    if(a->tt==TOKEN_NUMBER){
        ...
        if(SuperALX_DrefType(ll,v->typename)){
            ...
            SuperALX_Variable_Build_Decl(ll,stack_name,U16_TYPE"*");
...
Token U16_Null_Handler_Cast(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
...
Token U16_Handler_Cast(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);

    if(op->str==NULL)                   return U16_Null_Handler_Cast(ll,op,args);
...
Token U16_Handler_Size(SuperALX* ll,Token* op,Vector* args){
    Token* a = (Token*)Vector_Get(args,0);
    //printf("[U16]: SIZE: %s\n",a->str);
...
void Ex_Packer(ExternFunctionMap* Extern_Functions,Vector* funcs,Scope* s){//Vector<CStr>
    TypeMap_PushContained(&s->types,funcs,
        Type_Make(U16_TYPE,sizeof(SuperALXVariable),OperatorInterationMap_Make((OperatorInterater[]){
            OperatorInterater_Make((CStr[]){ NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_SUPERALX_NEG,(Token(*)(void*,Token*,Vector*))U16_Handler_Neg),
                OperatorDefiner_New(TOKEN_SUPERALX_INC,(Token(*)(void*,Token*,Vector*))U16_Handler_Inc),
                OperatorDefiner_New(TOKEN_SUPERALX_DEC,(Token(*)(void*,Token*,Vector*))U16_Handler_Dec),
                OperatorDefiner_New(TOKEN_SUPERALX_NOT,(Token(*)(void*,Token*,Vector*))U16_Handler_Not),
                OperatorDefiner_New(TOKEN_SUPERALX_ADR,(Token(*)(void*,Token*,Vector*))U16_Handler_Adr),
                OperatorDefiner_New(TOKEN_CAST,(Token(*)(void*,Token*,Vector*))U16_Handler_Cast),
                OperatorDefiner_New(TOKEN_SUPERALX_SIZE,(Token(*)(void*,Token*,Vector*))U16_Handler_Size),
                //OperatorDefiner_New(TOKEN_DESTROY,NULL),
                OPERATORDEFINER_END
            })),
            OperatorInterater_Make((CStr[]){ U8_TYPE,NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_SUPERALX_ASS,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Ass),
                OperatorDefiner_New(TOKEN_SUPERALX_ASD,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Asd),
                OperatorDefiner_New(TOKEN_SUPERALX_ASU,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Asu),
                OperatorDefiner_New(TOKEN_SUPERALX_ASM,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Asm),
                OperatorDefiner_New(TOKEN_SUPERALX_ASV,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Asv),
                OperatorDefiner_New(TOKEN_SUPERALX_ADD,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Add),
                OperatorDefiner_New(TOKEN_SUPERALX_SUB,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Sub),
                OperatorDefiner_New(TOKEN_SUPERALX_MUL,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Mul),
                OperatorDefiner_New(TOKEN_SUPERALX_DIV,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Div),
                OperatorDefiner_New(TOKEN_SUPERALX_MOD,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Mod),
                OperatorDefiner_New(TOKEN_SUPERALX_AND,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_And),
                OperatorDefiner_New(TOKEN_SUPERALX_OR,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Or),
                OperatorDefiner_New(TOKEN_SUPERALX_XOR,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Xor),
                OperatorDefiner_New(TOKEN_SUPERALX_EQU,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Equ),
                OperatorDefiner_New(TOKEN_SUPERALX_NEQ,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Neq),
                OperatorDefiner_New(TOKEN_SUPERALX_LES,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Les),
                OperatorDefiner_New(TOKEN_SUPERALX_GRT,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Grt),
                OperatorDefiner_New(TOKEN_SUPERALX_LEQ,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Leq),
                OperatorDefiner_New(TOKEN_SUPERALX_GRQ,(Token(*)(void*,Token*,Vector*))U16_U16_Handler_Grq),
                OPERATORDEFINER_END
            })),
