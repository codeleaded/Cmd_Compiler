...
GLOBAL_STR19: db "Hello + ",0
GLOBAL_STR20: db " + World!",10,0
...
f.main:
    ...
    mov QWORD[rsp + 32 + 8],rax
    mov rax,QWORD[rsp + 0 + 16]
    mov QWORD[rsp + 32 + 16],rax
    mov rax,QWORD[rsp + 0 + 24]
    mov QWORD[rsp + 32 + 24],rax
    add rsp,32
    sub rsp,8
    sub rsp,8
    sub rsp,8
