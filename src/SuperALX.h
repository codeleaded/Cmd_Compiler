    ...
    ll.ev = Compiler_New(
        ...
        ShutingYard_New(
            PrecedenceMap_Make((Precedencer[]){
                ...
                Precedencer_New(TOKEN_SUPERALX_ADD,3),
                Precedencer_New(TOKEN_SUPERALX_SUB,2),
                Precedencer_New(TOKEN_SUPERALX_MUL,4),
                Precedencer_New(TOKEN_SUPERALX_DIV,5),
                Precedencer_New(TOKEN_SUPERALX_MOD,5),
                Precedencer_New(TOKEN_SUPERALX_NEG,7),
                Precedencer_New(TOKEN_SUPERALX_INC,7),
                Precedencer_New(TOKEN_SUPERALX_DEC,7),

                Precedencer_New(TOKEN_SUPERALX_AND,2),
                Precedencer_New(TOKEN_SUPERALX_OR,2),
                Precedencer_New(TOKEN_SUPERALX_XOR,2),
                Precedencer_New(TOKEN_SUPERALX_NOT,1),
                ...
                Precedencer_New(TOKEN_SUPERALX_GRT,2),
                Precedencer_New(TOKEN_SUPERALX_LEQ,2),
                Precedencer_New(TOKEN_SUPERALX_GRQ,2),

                Precedencer_New(TOKEN_SUPERALX_ACS,8), 
                Precedencer_New(TOKEN_SUPERALX_ARW,8),
                Precedencer_New(TOKEN_SUPERALX_ADR,7),
                Precedencer_New(TOKEN_SUPERALX_DRF,7),
                Precedencer_New(TOKEN_SUPERALX_DDOT,PRECEDENCE_DONTCARE),
                Precedencer_New(TOKEN_SUPERALX_DDDOT,PRECEDENCE_DONTCARE),
                Precedencer_New(TOKEN_SUPERALX_SUBS,6),
                ...
                Precedencer_New(TOKEN_CAST,7),
                Precedencer_New(TOKEN_SUPERALX_SIZE,7),
